                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                            <a href="{{route('dashboard')}}" class="logo-link nk-sidebar-logo">
                                <img class="logo-light logo-img" src="{{ asset('images/logos/logo.png') }}" srcset="{{asset('images/logos/logo.png').' 320w,'.asset('images/logos/logo.png').' 800w,'.asset('images/logos/logo.png').' 1200w'}}" alt="logo">
                                <img class="logo-dark logo-img" src="{{ asset('images/logos/logo.png') }}" srcset="{{asset('images/logos/logo.png').' 320w,'.asset('images/logos/logo.png').' 800w,'.asset('images/logos/logo.png').' 1200w'}}" alt="logo-dark">
                            </a>                        
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="nk-header-wrap">
                            ...
                            <a href="{{route('dashboard')}}" class="logo-link">
                                <img class="logo-light logo-img" src="{{ asset('images/logos/White.svg') }}" srcset="{{asset('images/logos/White.svg').' 320w,'.asset('images/logos/White.svg').' 800w,'.asset('images/logos/White.svg').' 1200w'}}" alt="logo">
                                <img class="logo-dark logo-img" src="{{ asset('images/logos/White.svg') }}" srcset="{{asset('images/logos/Black.svg').' 320w,'.asset('images/logos/Black.svg').' 800w,'.asset('images/logos/Black.svg').' 1200w'}}" alt="logo-dark">
                            </a>                                  
                            </div><!-- .nk-header-brand -->
                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    ...
                                                    <div class="user-name dropdown-indicator">{{$current_user->first_name}} {{$current_user->last_name}}</div>
                                                </div>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span class="lead-text">{{$current_user->first_name}} {{$current_user->last_name}}</span>
